...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    <div class="navbar-header">
     ...
     <a class="navbar-brand" href="home"><font  face="Gadget" size="50" color="sky blue"><span style=padding-right:20px><img src="<c:url value="/resources/images/s3.jpg"/>" width="50" height="30">Rass O'Bikes</font> <i> <sub>lets ride...!</sub></span></a></i>
...
<div class="container">
<iframe width="560" height="315" src="//www.youtube.com/embed/WmoybhEsWrg" frameborder="0" allowfullscreen></iframe>
